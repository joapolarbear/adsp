...
set port_base_usp 14300
set port_base_ssp 14370
set port_base_alter 14350
set port_base_tap 14360
set port_base_ada 14320

set sleep_time 8
set sleep_time2 8
set timeout 180
set training_end -100000.0
set batch_size 64
...
if { $job_name == "ps" } {
	...
	if { $model == "usp" } {
		expect "$user@"
		send "nohup python2.7 -u client_chiller.py \
			--job_name=ps \
			--host='$ps_ip' \
			--port_base=$port_base_usp \
			--base_dir='/home/ubuntu/hphu/chiller/' \
			--class_num=10 \
			--worker_num=$wk_num \
