...
set port_base_usp 14400
set port_base_ssp 14470
set port_base_alter 14450
set port_base_tap 14460
set port_base_ada 14420

set timeout 180
set training_end 1.7
set batch_size 128

set learning_rate 0.1

set filter_size 1
set feature_size 1000
...
if { $job_name == "ps" } {
	...
	if { $model == "usp" } {		
		...
		send "nohup python2.7 -u client.py \
			...
			--base_dir='/home/ubuntu/hphu/rail/' \
			--class_num=10 \
			--worker_num=$wk_num \
