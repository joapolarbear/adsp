...
allList = [scale_18_usp, scale_36_usp, scale_18_alter, scale_36_alter]
name_list = ['ADSP: 18 workers', 'ADSP: 36 workers', 'Fixed ADACOMM: 18 workers', 'Fixed ADACOMM: 36 workers']
num_list = [18, 36]
end = 1.0
...
bars = ax.bar(index2, stop_point[2:], 
	width=bar_width,
	# edgecolor="black",
	# markeredgewidth=2, 
	label = 'ADSP'
...
bars = ax.bar(index, stop_point[:2], 
	width=bar_width,
	# edgecolor="black",
	# markeredgewidth=2
	label = 'Fixed ADACOMM'
