...
class STRAIN_PS(object):
	...
	def offlineSearch1Min(self, max_mu, max_eta, max_dec, _mu, _eta, init_loss, backup_para, backup_v_para, ps_t):
	...
	def onlineSearch1Min(self, 
		...
		if(reward > max_reward):
			...
			max_mu = mu
			max_eta = eta
		print("current opt mu: %f \t eta: %f\treward: %f" % (max_mu, max_eta, max_reward))
